...
方案一的具体实现大家可以参考github上面的一个项目[**apng-view**](https://github.com/sahasbhop/apng-view)，方案二的具体实现，即ApngReader的实现参见简书[**Android-Apng动画的播放**](https://www.jianshu.com/p/8114ed31c535)。
